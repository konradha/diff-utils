...
def test_passthrough():
    ...
    phi_out = eigenvector_gate(phi, x_star, d, e)
...
def test_analytic_4x4():
    ...
    phi_out = eigenvector_gate(phi, x_star_a, d_a, e_a)
...
def test_finite_difference_diagonal():
    ...
    phi_out = eigenvector_gate(phi, x_star, d_a, e.detach())
...
def test_degpert_no_clusters_matches_standard():
    ...
    for m in range(M):
        ...
        phi_out = eigenvector_gate(phi[m], x_a, d_a, e_a)
